    ...
    <xsl:template match="tei:bibl">
        ...
        <div class="background-1">
            ...
            <div class="row-2">
                ...
                <button id="english-button" onclick="toggleManuscripts()">Show Manuscripts</button>
                
                <!-- Arabic button aligned right -->
                <button id="arabic-button" onclick="toggleManuscripts()">عرض المخطوطات</button>
                ...
                <div id="manuscript-info" style="display:none;">
                    ...
                    <!-- You can add more detailed information or other content here -->
                </div>
            ...
            <script>
                ...
                englishButton.textContent = 'Hide Manuscripts';
                arabicButton.textContent = 'اخفاء المخطوطات'; // Arabic for 'Hide Manuscripts'
                } else {
                infoDiv.style.display = 'none';
                englishButton.textContent = 'Show Manuscripts';
                arabicButton.textContent = 'عرض المخطوطات'; // Arabic for 'Show Manuscripts'
                }
                }
            </script>
