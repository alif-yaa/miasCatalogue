        ...
        <div class="backdrop">
                    ...
                    <div class="row-2">
                        <div class="h4">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="@role = 'dub'">Misattrib.</xsl:when>
            ...
            <div class="background">
                ...
                <div class="row-2">
                    ...
                    <div class="box-ref">
                        <xsl:value-of
                            select="tei:noteGrp[@type = 'references']/tei:note[@type = 'fut_mak'][@resp = 'MIAS']/tei:ref"
                        />
                    </div>
                    <div class="box-ref">
                        <xsl:value-of
                ...
                <div class="row">
                    ...
                    <div class="box">
                        <xsl:apply-templates
                            select="tei:noteGrp[@type = 'references']/tei:note[@type = 'fut_mak'][@resp = 'MIAS']/node()[not(self::tei:ref)]"
                        />
                    </div>
                    <div class="h4-arabic"/>
                </div>
            ...
            <div class="background">
                ...
                <!-- Filter bibliography items by the tag "amr" -->
                ...
                <div class="margin-bottom-10"/>
                <xsl:for-each select="$filteredBibliography[tei:note[@type='tags']/tei:note[@type='tag']='edition']">
                ...
                <div class="margin-bottom-10"/>
                <xsl:for-each select="$filteredBibliography[tei:note[@type='tags']/tei:note[@type='tag']='translation']">
                    <xsl:sort select="concat(
                        normalize-space(tei:monogr/tei:author[1]/tei:surname[1]), 
                        normalize-space(tei:analytic/tei:author[1]/tei:surname[1]), 
                        normalize-space(tei:monogr/tei:editor[1]/tei:surname[1])
                ...
                <div class="margin-bottom-10"/>
                <xsl:for-each select="$filteredBibliography[tei:note[@type='tags']/tei:note[@type='tag']='study']">
                    <xsl:sort select="concat(
                        normalize-space(tei:monogr/tei:author[1]/tei:surname[1]), 
                        normalize-space(tei:analytic/tei:author[1]/tei:surname[1]), 
                        normalize-space(tei:monogr/tei:editor[1]/tei:surname[1])
