...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Template to match the root and generate files for each <bibl> element -->
    <xsl:template match="/">
        <xsl:apply-templates select="//tei:bibl"/>
            ...
            <xsl:template match="tei:bibl">
                <!-- Get the xml:id of the current bibl element -->
                <xsl:variable name="fileName" select="concat(@xml:id, '.html')"/>
                
                <!-- Create a new HTML file for each bibl element -->
                <xsl:result-document href="{$fileName}" method="html">
                    ...
                    p + p {
                    margin-top: 8px; /* This is the margin between paragraphs */
                    }
                    /* Smaller text */
                    .text-smaller {
                        font-size: 0.8em;
            ...
            <div class="background">
                ...
                <div id="manuscript-info" style="display:none;">
                    ...
                    <div class="row-2">
                        <div class="column-left">
                            <div class="h5">Once the manuscript data has been migrated, it will be linked to the relevant works in the new system in a very similar way to the current website.</div>
                        </div>
                    </div>
                ...
                arabicButton.innerHTML = 'عرض المخطوطات <i class="fa fa-chevron-down chevron"/>';w
                }
                }
            </script>
            </div>
                    ...
                    <div class="row">
                        <div class="h4">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:when test="@type = 'ant-'">Antec. Of</xsl:when>
                                <xsl:otherwise>
            ...
            <div class="background">
                ...
                <xsl:variable name="workId" select="current()/@xml:id"/>

                <!-- Filter bibliography items by the $workId variable -->
